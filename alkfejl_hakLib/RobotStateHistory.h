...
public:
    ...
    /** RobotStateHistory első unit teszt függvénye - RobotStateHistory changed or not*/
    int historyHasChanged();

    /** RobotStateHistory második unit teszt függvény - képernyők törlése */
    int clearScreen();
